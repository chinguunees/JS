...
// }
// while (loop < 11) {
//   console.log(text, "while 10 loop");
//   loop++;
// }
// while (loop < 30) {
//   console.log(text, "while 30 loop");
//   loop++;
// }

// for (loop = 0; loop < 21; loop++) {
//   if (loop % 2 !== 0) {
//     console.log(loop, "sondgoi");
//   }
// }
// for (loop = 0; loop < 41; loop++) {
//   if (loop % 2 === 0) {
//     console.log(loop, "tegsh");
//   }
// }
// let sum = 0;
// for (loop = 0; loop < 21; loop++) {
...
//   }
// }
// console.log(sum, "total sondgoi sum");

// let bodlogo15Niilber = 0;
// for (loop = 0; loop < 15; loop++) {
//   console.log(loop, "bodlogo 15");
//   bodlogo15Niilber = loop + bodlogo15Niilber;
// }
// console.log(bodlogo15Niilber, "14 hurtelh toonii niilber");
